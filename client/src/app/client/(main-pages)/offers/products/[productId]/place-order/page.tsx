...
const PlaceOrder = ({ params }: { params: { productId: number } }) => {
  return (
    <div className="flex justify-center gap-14 h-screen p-20">
      <div className="border-orangePrimary border w-[30%] rounded-lg gap-6 p-10 flex flex-col items-center h-full">
        <Image
          ...
          width={350}
        />
        <div className="text-orangePrimary flex flex-col items-center gap-3">
      ...
      <div className="border-orangePrimary border w-[40%] rounded-lg  p-10">
        <form action="" className="flex flex-col gap-3 h-full text-white">
          ...
          <div className="h-full">
            ...
            <textarea className="border border-orangePrimary bg-background resize-none rounded-lg w-full h-[90%] p-3"></textarea>
          </div>
